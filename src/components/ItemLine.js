            ...
            return (
                ...
                >
                    ...
                    >
                        ...
                        {stateImage && (
                            <Image source={stateImage} style={styles.warn} />
                        )}
                        {Left}
                        {Right}
                    </View>
            ...
            >
                <View
                    style={[
                        styles.content,
                        noBorder && { borderBottomWidth: 0 },
                        isInput && { borderColor: UI.color.border2 },
                    ]}
                >
                    {Icon && (
                        <View style={{ marginRight: UI.unit * 3 }}>{Icon}</View>
                    )}
                    {Left}
                    {Right}
                </View>
