import { TouchableWithImage } from '../touchableView/touchableView';
import { ImageResource } from '../../img/ImageData';
...
const ScrollableTabButtonBar = createReactClass({
    propTypes: {
        ...
        return (
            ...
            >
                {isHideBackBtn ? null : (
                    <TouchableWithImage
                        onPress={() => {
                            NativeModules.IntentModule.onBackPressed();
                        }}
                        imageContainerStyle={{ width: 38, height: 38 }}
                        normalImg={ImageResource.entry.entry_back_bg}
                        pressedImg={ImageResource.entry.entry_back_click_bg}
                    />
                )}
                <ScrollView
                    ref={scrollView => {
...
module.exports = ScrollableTabButtonBar;
